import{d as p,_ as u,y as h,b as a,e as t,x as s,A as r,F as f,Z as v,o as l,$ as g,l as x,g as b}from"../modules/vue-DqM6j7Au.js";import{u as y,h as N,c as m,b as k}from"../index-CydXal7A.js";import{N as w}from"./NoteDisplay-CExXvJ2O.js";import"../modules/shiki-BjLwEkPr.js";const L={id:"page-root"},T={class:"m-4"},V={class:"mb-10"},B={class:"text-4xl font-bold mt-2"},D={class:"opacity-50"},H={class:"text-lg"},S={class:"font-bold flex gap-2"},j={class:"opacity-50"},A=t("div",{class:"flex-auto"},null,-1),C={key:0,class:"border-main mb-8"},F=p({__name:"print",setup(M){const{slides:d,total:_}=y();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
